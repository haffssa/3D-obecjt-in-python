...
while True:
    ...
    # boucle principale pour afficher le cube
    done = False
    # while not done:
    for event in pygame.event.get():
            if event.type == MOUSEBUTTONDOWN:
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    # ajouter l'angle de rotation correspondant à la position de la souris
                    angle_x += mouse_delta[0] * 0.2
                    angle_y += mouse_delta[1] * 0.2
